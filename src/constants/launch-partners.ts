...
export const TESTIMONIALS: Testimonial[] = [
  {
    logo: process.env.PUBLIC_URL + '/imgs/assets/features/discord_img1.svg',
    persona: 'Create an invite-only place where you belong',
    description: `Polywrap will make it easy for everyone to build on top of  Discord servers are organized into topic-based channels
    where you can collaborate, share, and just talk about your
    day without clogging up a group chat.`,
    url: 'https://gnosis.io/',
  },
  {
    logo: process.env.PUBLIC_URL + '/imgs/assets/features/discord_img4.svg',
    persona: 'Where hanging out is easy',
  ...
  {
    logo: process.env.PUBLIC_URL + '/imgs/assets/features/discord_img3.svg',
    persona: 'From few to a fandom',
